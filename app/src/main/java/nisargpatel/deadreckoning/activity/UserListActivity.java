...
public class UserListActivity extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userList = ExtraFunctions.getArrayFromSharedPreferences("user_list", sharedPreference);//유저리스트를 받아옴.
        strideList = ExtraFunctions.getArrayFromSharedPreferences("stride_list", sharedPreference);//걸음 걸이를 받아옴.
        ...
        myList.setOnItemClickListener(new AdapterView.OnItemClickListener() {//아이템 항목 하나 클릭시
            @Override
        ...
        buttonNewUser.setOnClickListener(new View.OnClickListener() {//새로운 사용자 추가 리스너
            @Override
            public void onClick(View v) {
                ...
                UserDetailsDialogFragment userDetailsDialog = new UserDetailsDialogFragment();//다이얼로그 띄움
                userDetailsDialog.setHandler(new UserListHandler(UserListActivity.this, myList));//처리 핸들러 전달. 자동 계산 클릭시
