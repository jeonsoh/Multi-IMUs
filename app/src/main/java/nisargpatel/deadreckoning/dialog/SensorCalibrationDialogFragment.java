...
public class SensorCalibrationDialogFragment extends DialogFragment {
    ...
    public void onStart() {
        ...
        if (alertDialog != null) {
            Button negativeButton = alertDialog.getButton(Dialog.BUTTON_NEGATIVE);//Cancel 버튼 클릭시
            ...
            Button positiveButton = alertDialog.getButton(Dialog.BUTTON_POSITIVE);//Calibration 버튼 클릭시
